  ...
  return (
    ...
    >
      <div className="flex min-w-0 flex-col items-center justify-between px-3 py-3 md:flex-row md:px-6 md:py-5">
        <h1 className="text-center font-serif text-xl font-light leading-tight text-slate-900 md:text-left md:text-2xl">
          MartynRoberts.dev
        </h1>

        <nav className="w-full min-w-0 md:w-auto" aria-label="Main navigation">
          <ul className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 pt-4 text-sm font-light text-slate-900 md:flex-nowrap md:gap-6 md:pt-0 md:text-base lg:gap-8">
            <li>
