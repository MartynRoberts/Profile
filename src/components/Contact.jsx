        ...
        {status !== "success" && (
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full rounded-lg bg-theme px-6 py-3 font-semibold text-white transition hover:cursor-pointer hover:bg-theme-hover hover:underline focus:outline-none focus:ring-4 focus:ring-theme/30 active:bg-theme-dark active:text-white"
            >
